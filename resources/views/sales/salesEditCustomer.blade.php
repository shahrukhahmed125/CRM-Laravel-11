...
<div class="main-panel">
    ...
    <div class="">
        ...
        <form action="{{route('sales.editCustomerDataPost', $data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('sales.customerData')}}" class=" mt-3 btn btn-danger btn-lg">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
