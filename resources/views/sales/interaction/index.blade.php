                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <td>
                            <a href="{{route('sales.interactions.show', $interaction->id)}}" class="btn btn-info btn-sm">View</a>
                            <a href="{{route('sales.interactions.edit', $interaction->id)}}" class="btn btn-warning btn-sm">Edit</a>
                        </td>
                    </tr>
                    @empty
                        <tr>
