                ...
                <table class="table">
                  ...
                  <tbody>
                    @foreach ($pipelines as $pipeline)
                        ...
                        <td>
                          <a href="{{ route('sales.pipelines.show', $pipeline->id) }}" class="btn btn-info btn-sm">View</a>
                          <a href="{{ route('sales.pipelines.edit', $pipeline->id) }}" class="btn btn-warning btn-sm">Edit</a>
                        </td>
                        </tr>
