                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <td>
                            <a href="{{route('support.interactions.show', $interaction->id)}}" class="btn btn-info btn-sm">View</a>
                            <a href="{{route('support.interactions.edit', $interaction->id)}}" class="btn btn-warning btn-sm">Edit</a>
                        </td>
                    </tr>
                    @empty
                        <tr>
