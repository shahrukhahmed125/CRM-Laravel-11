@extends('masterpage')
@section('title', 'Log Interactions')
@section('css')
      ...
      <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Log Interactions</li>
            </ol>
        </nav>
      </div>
      <div class="row ">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Customers Interactions</h4>
              <div class="">

                <form action="{{ route('support.interactions.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                          <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('details') is-invalid @enderror"" id="exampleTextarea1" rows="6" name="details" id="details"></textarea>
                                            @error('details')
                                              <p class="invalid-feedback">{{'*'.$message}}</p>
                                            @enderror
                                          </div>
                                    ...
                                    <div class="row mt-3">
                                      ...
                                      <div class="col-6">
                                        <div class="form-group">
                                          ...
                                          <input type="datetime-local" name="reminder_at" id="reminder_at" class="form-control  form-control-lg">
                                        </div>
                                      </div>
                                    </div>
                                    <button type="submit" class=" mt-3 btn btn-success btn-lg">Log Interaction</button>
                                </div>
                            </div>
                        </div>
                    </div>
