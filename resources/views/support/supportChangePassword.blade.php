@extends('masterpage')
@section('title', 'Support Change Password')
@section('css')
            ...
            <div class="row">
                  <div class="col-md-12 grid-margin stretch-card">
                      ...
                      <div class="card-body">
                          ...
                          <form class="forms-sample" action="{{route('suport.changePasswordPost')}}" method="POST">
                          @csrf
                          ...
                          <a class="btn btn-dark" href="{{route('support.dashboard')}}">Cancel</a>
                          </form>
                      </div>
                      </div>
                  </div>
