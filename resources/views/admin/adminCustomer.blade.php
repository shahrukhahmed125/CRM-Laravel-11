                    ...
                    <table class="table">
                      ...
                      <tbody>
                        @foreach ($data as $client)
                            ...
                            <td>
                              <a href="{{route('admin.editCustomerData', $client->id)}}" class="btn btn-warning btn-sm">Edit</a>
                              <a href="{{route('admin.deleteCustomerData', $client->id)}}" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                            </tr>
