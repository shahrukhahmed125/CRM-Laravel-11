                    ...
                    @else
                        ...
                        <tbody>
                            @foreach ($data as $client)
                                ...
                                <td>
                                <a href="{{route('admin.editCustomerData', $client->id)}}" class="btn btn-warning">Edit</a>
                                <a href="{{route('admin.deleteCustomerData', $client->id)}}" class="btn btn-danger">Delete</a>
                                </td>
                                </tr>
