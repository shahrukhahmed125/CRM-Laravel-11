                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <td>
                            <a href="{{route('admin.interactions.show', $interaction->id)}}" class="btn btn-info btn-sm">View</a>
                            <a href="{{route('admin.interactions.edit', $interaction->id)}}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('admin.interactions.destroy', $interaction->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
