...
<div class="main-panel">
    ...
    <div class="">
        ...
        <form action="{{route('admin.editCustomerDataPost', $data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg @error('first_name') is-invalid @enderror" name="first_name"
                                            value="{{$data->first_name}}" placeholder="Ex: John">
                                        @error('first_name')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg @error('last_name') is-invalid @enderror" name="last_name"
                                            value="{{$data->last_name}}" placeholder="Ex: John">
                                        @error('last_name')
                                            <p class="invalid-feedback">{{'*'.$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control form-control-lg" id="datepicker" value="{{$data->dob}}"
                                                name="dob" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="{{route('admin.customerData')}}" class=" mt-3 btn btn-danger btn-lg">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
