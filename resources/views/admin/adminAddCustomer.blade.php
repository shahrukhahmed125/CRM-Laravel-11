@extends('masterpage')
@section('title', 'Admin Add Customer')
@section('css')
...
<div class="main-panel">
    ...
    <div class="">
        ...
        <form action="{{route('admin.addCustomerDataPost')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group mt-3">
                                        <label>Address</label>
                                        <textarea class="form-control" id="exampleTextarea1" rows="6" name="address"></textarea>
                                    </div>
                                </div>
                            </div>
